...
class GenerusForm
{
  ...
  public static function getPaudForm(Get $get) {
    return [
      ...
      Forms\Components\Textarea::make('detail_status')
          ->label('Nama Paud/TK')
          ->placeholder(fn() => Status::query()->where('slug', 'paudtk')->value('placeholder'))
          ->required(),
      ];
    }

  public static function getCaberawitForm(Get $get) {
    return [
        Forms\Components\TextInput::make('nama')
            ->label('Nama Lengkap')
            ->placeholder('Masukkan Nama Lengkap')
        ...
        Forms\Components\Textarea::make('detail_status')
            ->label('Nama SD')
            ->placeholder(fn() => Status::query()->where('slug', 'sd')->value('placeholder'))
            ->required(),
        Forms\Components\Select::make('kelas_di_sekolah')
            ...
            ->required(),
        Forms\Components\TextInput::make('kelas_di_ppg')
            ->label('Kelas di PPG'),
        ];
    }

  public static function getPraRemajaForm(Get $get) {
    return [
        Forms\Components\TextInput::make('nama')
            ->label('Nama Lengkap')
            ->placeholder('Masukkan Nama Lengkap')
        ...
        Forms\Components\Textarea::make('detail_status')
            ...
            ->placeholder(fn() => Status::query()->where('slug', 'smp')->value('placeholder'))
            ->required(),
        Forms\Components\Select::make('kelas_di_sekolah')
            ->label('Kelas di sekolah')
            ->options([
  ...
  public static function getRemajaForm(Get $get) {
    return [
        Forms\Components\TextInput::make('nama')
            ->label('Nama Lengkap')
            ->placeholder('Masukkan Nama Lengkap')
        ...
        Forms\Components\Textarea::make('detail_status')
            ->label('Nama Sekolah SMA/K')
            ->placeholder(fn() => Status::query()->where('slug', 'sma-smk')->value('placeholder'))
            ->required(),
        Forms\Components\Select::make('kelas_di_sekolah')
            ->label('Kelas di sekolah')
            ->options([
    ...
    public static function getPraNikahForm(Get $get) {
        return [
            Forms\Components\TextInput::make('nama')
                ->label('Nama Lengkap')
                ->placeholder('Masukkan Nama Lengkap')
            ...
            Forms\Components\Select::make('status_id')
                ...
                ->relationship(
                    ...
                    modifyQueryUsing: fn(Builder $query) => $query->whereNotIn('slug', ['paudtk','sd','smp','sma-smk']),
                )
                ->live()
                ->required(),
            Forms\Components\Textarea::make('detail_status')
