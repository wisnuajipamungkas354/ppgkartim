...
class InsanPolicy
{
     ...
     */
    public function view(User $user, Insan $insan): bool
    {
     ...
     */
    public function update(User $user, Insan $insan): bool
    {
     ...
     */
    public function delete(User $user, Insan $insan): bool
    {
     ...
     */
    public function forceDelete(User $user, Insan $insan): bool
    {
     ...
     */
    public function restore(User $user, Insan $insan): bool
    {
     ...
     */
    public function replicate(User $user, Insan $insan): bool
    {
