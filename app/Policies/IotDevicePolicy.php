...
class IotDevicePolicy
{
    ...
    {
        return $user->can('force_delete_iot::device');
    }
    ...
    {
        return $user->can('force_delete_any_iot::device');
    }
    ...
    {
        return $user->can('restore_iot::device');
    }
    ...
    {
        return $user->can('restore_any_iot::device');
    }

    /**
     * Determine whether the user can replicate.
     */
    public function replicate(User $user, IotDevice $iotDevice): bool
    {
        return $user->can('replicate_iot::device');
    }
    ...
    {
        return $user->can('reorder_iot::device');
    }
}
